...
: ${AMENT_CURRENT_PREFIX:="/home/hac/ros2_ws/src/808x-final-project/install/808x-final-project"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/808x-final-project/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/808x-final-project/environment/path.sh"
