/**
 * @file perception.hpp
 * @brief Declaration file for the Perception class, responsible for detecting
 * books using image processing.
 ...
 *
 * This class is responsible for detecting books, moving the robot towards the
 * book using camera and LiDAR data, and managing various flags for control
 * logic.
 */
class Perception : public rclcpp::Node {
 public:
  ...
  /**
   * @brief Callback function to subscribe to the odometry topic while
   * searching.
   *
